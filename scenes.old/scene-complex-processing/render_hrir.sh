...
tascar_jackio -v -f -t "${DIR}/statistics.txt" -o "${OUTFILE}" "${DIR}/impulse.wav" render.main:probe.0 hrirconv:out_0 hrirconv:out_1 hrirconv:out_2 hrirconv:out_3 2>&1 | sed 's/^/[JACKIO]/g'
